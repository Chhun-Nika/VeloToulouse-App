...
import 'package:velo_toulouse_app/data/repositories/bookings/booking_repository_firebase.dart';
...
List<InheritedProvider> get devProviders {
  return [
    ...
    // 4 - inject booking repository
    Provider<BookingsRepository>(create: (_) => BookingRepositoryFirebase()),
  ];
}
